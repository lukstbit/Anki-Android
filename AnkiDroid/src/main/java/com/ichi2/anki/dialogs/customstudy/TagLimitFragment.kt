 ...
 * session that is being creating. Similar with the desktop TagLimit class.
...
class TagLimitFragment : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        val dialogView = layoutInflater.inflate(R.layout.fragment_custom_study_tags_selection, null)
